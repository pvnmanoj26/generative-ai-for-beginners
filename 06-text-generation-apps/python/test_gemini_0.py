...
def start_quiz():
    ...
    Make sure to include the correct answer and provide a brief explanation after each question. Make sure to identify questions with * at start and end. Idenitfy options with ** at start and end. Idenitfy answer with *** at start and end. For example *1. What do we use to hit the ball in cricket?*
...
***C is the correct answer!***  A cricket ball is round, just like a bouncy ball!
    """

    # Step 3: Get quiz questions from Gemini
    quiz_content = get_gemini_response(quiz_prompt,0.9)
    if not quiz_content:
